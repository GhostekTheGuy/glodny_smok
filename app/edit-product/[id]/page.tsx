  ...
  if (!product) {
    return (
      <div className="container mx-auto px-4 py-8">
        <div className="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded">Nie znaleziono produktu</div>
      </div>
    )
  }
        ...
        <div className="relative flex flex-col min-h-[calc(60vh-8rem)] md:h-[calc(100vh-12rem)]">
          ...
          <div className="fixed left-0 right-0 bottom-0 md:absolute bg-white border-t pt-4 px-4 md:px-0 pb-4 space-y-4">
            ...
            <div className="flex gap-4">
              <Button className="flex-1 bg-gray-500 hover:bg-gray-600 text-white" onClick={() => router.push("/cart")}>
                Anuluj
              </Button>
              <motion.button
                layout
